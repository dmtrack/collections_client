...
export const EditCollectionForm: FC<EditCollectionFormProps> = ({
    ...
    const {
        ...
        defaultValues: { itemConfigs: [{ type: '', label: '' }] },
    });
        ...
        <Box
            ...
            <TextField
                ...
                {themes.map((theme: ITheme) => (
                    <MenuItem key={theme.id} value={Number(theme.id)}>
                        {theme.name}
                    </MenuItem>
                ))}
            </TextField>
            ...
            <ConfigInputs
                configInputs={watch('itemConfigs')}
                setConfigInputs={(configs) => setValue('itemConfigs', configs)}
            />
